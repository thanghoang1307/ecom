									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												<input type="text" class="form-control" name="name" id="inputCompany" aria-describedby="inputCompany" placeholder="Tên công ty" value="{{old('name')}}">
												@error('name')
										...
										<div class="col-md-6">
											<div class="form-group">
												<input type="number" class="form-control" id="inputMST" aria-describedby="inputMST" name="mst" placeholder="Mã số thuế" value="{{old('mst')}}">
												@error('mst')
										...
										<div class="col-12">
											<div class="form-group">
												<input type="text" class="form-control" id="inputAddress" aria-describedby="inputAddress" placeholder="Số nhà, tên đường" name="address" value="{{old('address')}}">
												@error('address')
										...
										<div class="col-12">
											<div class="form-group">
												<textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="note" placeholder="Lời nhắn cho OneStopShop.vn">{{old('note')}}</textarea>
											</div>
										</div>
									</div>
								</div>
									...
									<div class="process-tab process-account">
										<div class="row">
											<div class="col-md-12">
												...
												<p class="transfer-note">Thanh toán cho đơn hàng số ...</strong>, OneStopShop</p>
											</div>
										</div>
							...
							<div class="process-profile-detail">
								...
								<div class="process-profile-block-sub">
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												<input type="text" class="form-control" name="name" id="inputCompany" aria-describedby="inputCompany" placeholder="Tên công ty">
											</div>
										</div>

										<div class="col-md-6">
											<div class="form-group">
												<input type="number" class="form-control" id="inputMST" aria-describedby="inputMST" name="mst" placeholder="Mã số thuế" value="">
											</div>
										</div>

										<div class="col-12">
											<div class="form-group">
												<input type="text" class="form-control" id="inputAddress" aria-describedby="inputAddress" placeholder="Số nhà, tên đường" name="address">
											</div>
										</div>

										<div class="col-12">
											<div class="form-group">
												<textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="note" placeholder="Lời nhắn cho OneStopShop.vn"></textarea>
											</div>
										</div>
									</div>
								</div>
