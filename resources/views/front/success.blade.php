      ...
      <section class="cart-process">
        <div class="process-list">
          <ul class="process-list-wrapper">
            <li><a href="check-out.html" class="active"><span class="d-none d-sm-block">Thông tin đặt hàng</span></a>
            </li>
            <li><a href="check-out-2.html" class="active"><span class="d-none d-sm-block">Thanh toán</span></a></li>
            <li><a href="check-out-3.html" class="active"><span>Hoàn tất đơn hàng</span></a></li>
          </ul>
        </div>
        <form action="#">
