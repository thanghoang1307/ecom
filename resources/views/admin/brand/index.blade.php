                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>{{$brand->name}}</td>
                      <td><a href="{{route('admin.brand.edit',$brand->id)}}"><button class="btn btn-primary"><i class="fas fa-edit"></i></button></a>
                      <a href="{{route('admin.brand.delete',$brand->id)}}"><button class="btn btn-danger"><i class="fas fa-trash"></i></button></a></td>
                    </tr>
                    @endforeach
